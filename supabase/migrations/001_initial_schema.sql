...
CREATE TABLE model_scores (
    ...
    usability_score DECIMAL(5,2) CHECK (usability_score >= 0 AND usability_score <= 100),
    innovation_score DECIMAL(5,2) CHECK (innovation_score >= 0 AND innovation_score <= 100),
    adoption_score DECIMAL(5,2) CHECK (adoption_score >= 0 AND adoption_score <= 100),
    production_score DECIMAL(5,2) CHECK (production_score >= 0 AND production_score <= 100),
